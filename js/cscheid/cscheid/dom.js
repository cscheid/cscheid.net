...
// this is slow!
// this assumes the canvas was setup with setupCanvas, or it'll scale improperly
export function convertToPixelUnits(size, canvas) {
  var scale = (canvas && canvas.getContext('2d').dpr) || 1;
