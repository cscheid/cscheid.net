...
(function() {
    ...
    function leastSquares(X, y, lambda) {
        var effdf = 0;
    ...
    data.leastSquares = leastSquares;

    // predict on normalized columns
    function normalizedLeastSquares(X, y, lambda) {
        var averages = [], stdevs = [];
    ...
    data.normalizedLeastSquares = normalizedLeastSquares;
})();
