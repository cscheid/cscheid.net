---
layout: bootstrap
title: Lecture 2, The basics of the web stack
---

# Lecture 2, The basics of the web stack

In this lecture, we go over the very basics of how the content of a web page
...
be used to access the element via Javascript (we'll see how soon).
Think of it as making the element accessible via a global
...
a sign that you could organize your code better (we will learn about
such good practices). (The `class` and `style`
...
<div><iframe src="lecture2/index.html" width="960" height="480">boo</iframe></div>

Go ahead, play around with the element tree in there. If you want to
see that page in a new tab, <a href="lecture2/index.html"
